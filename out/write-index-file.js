...
const generate_index_content_1 = require("./generate-index-content");
...
function writeIndexFile(targetFolder, withFolders, fileType) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (withFolders) {
            indexContent = generate_index_content_1.generateIndexContent(files, true, targetFolder, fileType);
        }
        else {
            indexContent = generate_index_content_1.generateIndexContent(files, false, targetFolder, fileType);
        }
        yield fsExtra.writeFile(indexFilePath, indexContent);
    });
}
exports.writeIndexFile = writeIndexFile;
//# sourceMappingURL=write-index-file.js.map